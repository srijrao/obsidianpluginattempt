...
var OpenAIProvider = /** @class */ (function () {
     ...
     */
    OpenAIProvider.prototype.getCompletion = function (messages, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 3:
                        _a = (_h.sent()) || { done: true, value: undefined }, done = _a.done, value = _a.value;
                        if (done)
                            return [3 /*break*/, 4];
                        ...
                        for (_i = 0, lines_1 = lines; _i < lines_1.length; _i++) {
                            ...
                            if (line.startsWith('data: ') && line !== 'data: [DONE]') {
                                ...
                                content = (_g = (_f = data.choices[0]) === null || _f === void 0 ? void 0 : _f.delta) === null || _g === void 0 ? void 0 : _g.content;
                    ...
                    case 5:
                        ...
                        if (error_1.name === 'AbortError') {
                            ...
                            console.error('Error calling OpenAI:', error_1);
                            throw error_1;
                        }
                        return [3 /*break*/, 6];
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, data.data
                                ...
                                .filter(function (id) { return id.startsWith('gpt-'); })];
                    case 3:
                        error_2 = _a.sent();
                        console.error('Error fetching OpenAI models:', error_2);
                        throw error_2;
     ...
     */
    OpenAIProvider.prototype.testConnection = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, {
                                success: true,
                                message: "Successfully connected to OpenAI! Found ".concat(models.length, " available models."),
                                models: models
                            }];
                    case 2:
                        error_3 = _c.sent();
